...
window.NOVERA_POSTS = [
  {
    ...
    "title": "8 New AI Tools to Explore — September 18, 2026",
    "description": "A reviewed look at 8 newly discovered AI tools across Video Generation, Image Generation, Coding & Development, and Research & Knowledge, with clear features, pricing models, and links to detailed listings.",
    "date": "2026-09-18",
    "updated": "2026-09-18",
    ...
    "toolSlugs": [
      ...
      "die-with-me",
      "cleverhack",
      "agentmemoryleaderboard",
      "aclif",
      "tabmail",
      "slaunt"
    ],
    "intro": [
      "This directory review surfaced 8 products with clearly defined use cases across Video Generation, Image Generation, Coding & Development, and Research & Knowledge. Rather than ranking unfamiliar products, this roundup explains what each tool is designed to do and where it fits.",
  ...
  },
  {
    ...
    "title": "6 New AI Tools to Explore — September 9, 2026",
    "description": "An editorially reviewed look at six new tools for adaptive learning, agent-assisted video, conversation practice, business workflows, market research, and project knowledge.",
    "date": "2026-09-09",
    "updated": "2026-09-10",
    "author": "Novera Editorial",
    "type": "New tools roundup",
    ...
    "intro": [
      "This review covers six recently discovered AI products across Education & Learning, Video Generation, Productivity & Automation, and Research & Knowledge. The selection ranges from adaptive course building and conversation practice to agent-assisted video editing, local-first business software, cited market research, and connected project records.",
  ...
  },
  {
    ...
    "intro": [
      "This directory review surfaced seven products with clearly defined uses across Image Generation, Video Generation, Coding & Development, and Research & Knowledge. The selection ranges from free creative and developer utilities to governed cloud infrastructure, with each entry presented as a practical starting point rather than a ranking.",
  ...
  },
  {
    ...
    "title": "5 New AI Tools to Explore — Week of August 24, 2026",
    "description": "An editorially reviewed look at five newly discovered AI tools across coding, productivity, video, and image creation, with verified capabilities, pricing models, and links to detailed listings.",
    "date": "2026-08-29",
    "updated": "2026-08-30",
    "author": "Novera Editorial",
    "type": "Weekly roundup",
    ...
    "intro": [
      "This week’s directory review surfaced five products with clearly defined use cases across Coding & Development, Productivity & Automation, Video Generation, and Image Generation. Rather than ranking unfamiliar products, this roundup explains what each tool is designed to do and where it fits.",
      "Every product below passed Novera’s automated URL, duplicate, and category checks before entering this editorial draft. Product capabilities and pricing can change, so use each detailed listing as a starting point and confirm important information on the official website."
    ],
