...
window.NOVERA_POSTS = [
  {
    ...
    "intro": [
      "This review covers six recently discovered products across Video Generation, Image Generation, Research & Knowledge, Coding & Development, and Productivity & Automation. The selection ranges from local video clipping and branching image edits to an agent-memory benchmark, an agent-focused SaaS CLI, open-source email clients, and a workplace agent control plane.",
